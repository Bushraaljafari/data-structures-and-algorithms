...
const toLastNames = people => {
  // Solution code here...
  let fullName =people.map( name =>{return (name.firstName+' '+name.lastName);});
  return fullName;
};
...
const addValues = (arr) => {
  // Solution code here...
  let result=arr.reduce((accumulator,value)=>{accumulator=accumulator+value;
...
const addPurchases = (arr) => {
  // Solution code here...
  let price =arr.reduce((accumulator,value)=>{accumulator=accumulator+value.purchasePrice;
    return accumulator;},0);
  return price;
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let lenghtOfArray=arr.reduce((accumulator,value)=>{accumulator=arr.length;
    return accumulator;}
  ,0);
...
const returnNames = (arr) => {
  // Solution code here...
  let starWars= arr.reduce((accumulator,value,index)=>{accumulator[index]=value.name;
  return accumulator;},[]);
  return starWars;
};
...
const reversedString = (str) => {
  // Solution code here...
  let arr=str.split('');
  let reverse=arr.reduce((accumulator,value)=>{accumulator=value+accumulator;
    return accumulator;},'');
  return reverse;
};
